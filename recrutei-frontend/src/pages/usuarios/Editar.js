...
export default function Novo({ history }) {
    ...
    const handleSubmit = async () => {
        try {
            ...
            for (let i in usuario) {
                if (!usuario[i] && notRequired.indexOf(i) < 0) {
    ...
    useEffect(() => {
        ...
        async function getUsuario() {
            ...
            const { perfil_id, nome, login, senha } = response.data;

            setUsuario({ perfil_id, nome, login, senha });
        };
                ...
                <Paper className={classes.root}>
                    <form className={classes.form}>
                        ...
                        <TextField
                            ...
                            onChange={handleChange}
                            style={{ width: 200 }}
                            helperText="Informe somente se desejar atualizar"
                        />
